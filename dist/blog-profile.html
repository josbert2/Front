...
<head>
  <!-- Title -->
  <title>Blog Profile | Front - Responsive Website Template</title>
              ...
              <ul class="navbar-nav">
                ...
                <li class="hs-has-sub-menu navbar-nav-item">
                  ...
                  <div id="blogSubMenu" class="hs-sub-menu dropdown-menu" aria-labelledby="blogMegaMenu" style="min-width: 230px;">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item active" href="./blog-profile.html">Blog Profile</a>
    ...
    <div class="container space-bottom-3">
      <div class="w-md-75 w-lg-60 mx-md-auto">
        ...
        <article class="card mb-3 mb-sm-5">
          <img class="card-img-top" src="./assets/img/900x450/img1.jpg" alt="Image Description">

          <div class="card-body">
            <a class="d-block small font-weight-bold text-cap mb-2" href="#">Business</a>

            <h2 class="h3"><a class="text-inherit" href="blog-single-article.html">Should Product Owners think like entrepreneurs?</a></h2>
        ...
        <!-- End Blog Card -->
        <article class="card mb-3 mb-sm-5">
          <img class="card-img-top" src="./assets/img/900x450/img13.jpg" alt="Image Description">

          <div class="card-body">
            <a class="d-block small font-weight-bold text-cap mb-2" href="#">Business</a>

            <h3><a class="text-inherit" href="blog-single-article.html">Front accounts - let's work together</a></h3>
        ...
        <article class="card mb-3 mb-sm-5">
          ...
          <div class="card-body">
            <a class="d-block small font-weight-bold text-cap mb-2" href="#">Community</a>

            <h3><a class="text-inherit" href="blog-single-article.html">How Google Assistant now helps you record stories for kids</a></h3>
            ...
            <div class="media align-items-center pt-5">
              <div class="avatar-group">
                ...
                <div class="avatar avatar-xs avatar-circle" data-toggle="tooltip" data-placement="top" title="Emily Milda">
        ...
        <!-- End Blog Card -->
        <article class="card mb-3 mb-sm-5">
          <img class="card-img-top" src="./assets/img/900x450/img7.jpg" alt="Image Description">

          <div class="card-body">
            <a class="d-block small font-weight-bold text-cap mb-2" href="#">Community</a>

            <h3><a class="text-inherit" href="blog-single-article.html">Do millennials care about saving?</a></h3>
