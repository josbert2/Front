...
*/
"use strict";$.extend({HSCore:{init:function(){$(document).ready((function(){$('[data-toggle="tooltip"]').tooltip(),$('[data-toggle="popover"]').popover()}))},components:{}}}),$.HSCore.init(),$(".scroll-link").click((function(){$(window).width()<768&&setTimeout((function(){$(".navbar-collapse.collapse").hasClass("show")?($(".navbar-collapse.collapse").removeClass("show"),$(".navbar-toggler").attr("aria-expanded",!1)):($(".navbar-collapse.collapse").addClass("show"),$(".navbar-toggler").attr("aria-expanded",!0))}),100)}))
/*
* Validation wrapper
* @version: 2.0.0 (Mon, 25 Nov 2019)
