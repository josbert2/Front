...
*/
"use strict";function setCookie(t,e,s){var a=new Date;a.setTime(a.getTime()+24*s*60*60*1e3);var i="expires="+a.toUTCString();document.cookie=t+"="+e+";"+i+";path=/"}$.extend({HSCore:{init:function(){$(document).ready((function(){$('[data-toggle="tooltip"]').tooltip(),$('[data-toggle="popover"]').popover()}))},components:{}}}),$.HSCore.init(),$(".scroll-link").click((function(){$(window).width()<768&&setTimeout((function(){$(".navbar-collapse.collapse").hasClass("show")?($(".navbar-collapse.collapse").removeClass("show"),$(".navbar-toggler").attr("aria-expanded",!1)):($(".navbar-collapse.collapse").addClass("show"),$(".navbar-toggler").attr("aria-expanded",!0))}),100)})),$(".none-click").click((function(t){t.preventDefault()})),$(".cookieok").click((function(){gtag("event","gc",{event_category:"acceptCookies",event_label:"acceptCookies"}),setCookie("acceptCookies",!0,60)}))
/*
* Validation wrapper
* @version: 2.0.0 (Mon, 25 Nov 2019)
